...
//        httpConn = Api.initSSL(requestURL);
...
//        httpConn = (HttpsURLConnection) url.openConnection();
        ...
        httpConn.setReadTimeout(240000);
     ...
     */
    public String addFormField(String name, String value) {
        String line = "";
        line += "--" + boundary + LINE_FEED;
        line += "Content-Disposition: form-data; name=\"" + name + "\"" + LINE_FEED;
        line += "Content-Type: text/plain; charset=" + charset + LINE_FEED;
        line += LINE_FEED;
        line += value + LINE_FEED;
